          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-50">
              {invoices.map((inv) => (
                ...
                >
                  <td className="px-6 py-4 text-sm font-mono text-gray-600">#{inv.id.toUpperCase()}</td>
                  ...
                  <td className="px-6 py-4 text-sm font-medium text-gray-900">${inv.amount.toFixed(2)}</td>
        ...
        <Modal isOpen={!!selectedInvoice} onClose={() => setSelectedInvoice(null)} title="Invoice Details">
            <div className="space-y-6">
                <div className="flex justify-between items-start">
                    <div>
                        <h4 className="text-xl font-bold text-gray-900">#{selectedInvoice.id.toUpperCase()}</h4>
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-100">
                    ...
                    <span className="text-2xl font-bold text-blue-600">${selectedInvoice.amount.toFixed(2)}</span>
                </div>
